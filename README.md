...
- 금일 주도주 기록은 이 기기 브라우저에 날짜별로 남습니다. 업종별 분석과 그날 코스피·코스닥 지수도 같이 남깁니다. bat으로 켜면 프로젝트 `기록/금일주도주.txt`에도 같은 내용이 쌓입니다. 폰·Vercel은 그 파일에 쓰지 못합니다.
- 금일 주도주는 동조 업종의 코스피·코스닥 시총 대장입니다. 등락률 1등이 아닙니다.
