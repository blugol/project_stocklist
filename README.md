...
- 금일 대장 기록은 이 기기 브라우저에 날짜별로 남습니다. 업종별 분석과 그날 코스피·코스닥 지수도 같이 남깁니다. 흐름 탭은 쌓인 날로 종목이 며칠 나왔는지, 이번 주·이번 달 동조 업종이 뭐였는지 셉니다. 내일 볼 목록이 아닙니다. bat으로 켜면 프로젝트 `기록/금일대장.txt`에도 같은 내용이 쌓입니다. 폰·Vercel은 그 파일에 쓰지 못합니다.
